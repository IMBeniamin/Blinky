...
class PythonConfiguration:
    ...
    def Validate(cls):
        ...
        for packageName in cls.__packages:
    ...
    def __ValidatePackage(cls, packageName):
        packageInstalled = importlib_util.find_spec(packageName)
        return cls.__InstallPackage(packageName) if packageInstalled is None else True
